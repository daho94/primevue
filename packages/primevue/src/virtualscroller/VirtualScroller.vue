            ...
            if (this.lazy) {
                Promise.resolve().then(() => {
                    this.lazyLoadState = {
                        ...
                        last: Math.min(this.step ? this.step : last, this.items?.length > 0 ? this.items.length - 1 : 0)
                    };
            ...
            if (isRangeChanged) {
                ...
                if (this.lazy && this.isPageChanged(first)) {
                    const lazyLoadState = {
                        ...
                        last: Math.min(this.step ? (this.getPageByFirst(first) + 1) * this.step : last, this.items?.length > 0 ? this.items.length - 1 : 0)
                    };
